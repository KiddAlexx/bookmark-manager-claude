...
description: Write clean, modern, and highly accessible HTML & JSX code, using semantically correct elements and attributes. Use when working on HTML / JSX code.
---
...
- **PREFER** native validation and input types (`email`, `url`, `number`, etc.)
  - Use `<input type="url">` for the bookmark URL field — provides free format
    validation and correct mobile keyboard before RHF validation runs
